    ...
    <div class="mb-6 overflow-hidden rounded-[32px] bg-gradient-to-r from-amber-500 via-orange-500 to-red-500 p-8 text-white shadow-2xl">
        <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <h1 class="mt-2 text-4xl font-extrabold">Edit Enrollment</h1>
                <p class="mt-2 max-w-2xl text-sm text-white/80">
                    Update student course enrollment details.
                </p>
            </div>
        </div>
    </div>
            ...
            <form wire:submit.prevent="update" class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="date" wire:model.live="enrolled_at"
                                   class="w-full rounded-2xl border @error('enrolled_at') border-red-500 bg-red-50 @else border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 @enderror px-5 py-4 text-slate-900 dark:text-white outline-none transition focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10">
                ...
                <div class="flex flex-col gap-3 border-t border-slate-100 dark:border-slate-800 pt-6 md:flex-row md:justify-end">
                    ...
                    <button type="submit"
                        ...
                        <span wire:loading.remove>Update Enrollment</span>
