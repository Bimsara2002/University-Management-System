    ...
    <div class="mb-6 overflow-hidden rounded-[32px] bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 p-8 text-white shadow-2xl">
        <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <h1 class="mt-2 text-4xl font-extrabold">Record Payment</h1>
                <p class="mt-2 max-w-2xl text-sm text-white/80">
                    Add a new fee payment record.
                </p>
            </div>
        </div>
    </div>
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" wire:model.live="description" placeholder="e.g. Semester 1 Registration Fee"
                                   class="w-full rounded-2xl border @error('description') border-red-500 bg-red-50 @else border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 @enderror px-5 py-4 text-slate-900 dark:text-white outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" wire:model.live="amount" placeholder="0.00"
                                   class="w-full rounded-2xl border @error('amount') border-red-500 bg-red-50 @else border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 @enderror px-5 py-4 text-slate-900 dark:text-white outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10">
                        ...
                        <div>
                            ...
                            <input type="date" wire:model.live="payment_date"
                                   class="w-full rounded-2xl border @error('payment_date') border-red-500 bg-red-50 @else border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 @enderror px-5 py-4 text-slate-900 dark:text-white outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10">
                        ...
                        <div>
                            ...
                            <select wire:model.live="payment_method"
                                    class="w-full rounded-2xl border @error('payment_method') border-red-500 bg-red-50 @else border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 @enderror px-5 py-4 text-slate-900 dark:text-white outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10">
