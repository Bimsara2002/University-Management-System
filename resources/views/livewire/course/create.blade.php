        ...
        <div class="rounded-[32px] bg-white p-10 shadow-xl lg:col-span-3">
            <form wire:submit.prevent="store">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                        <label class="mb-2 block font-extrabold text-slate-800">
                            Course Code <span class="text-red-500">*</span>
                        </label>
                        <input type="text"
                               wire:model.live="course_code"
                               placeholder="SE101"
                               class="w-full rounded-2xl border border-slate-200 bg-[#f8f7fd] px-5 py-4 text-base outline-none focus:border-[#4b3f8f]">
                ...
                <div class="mt-10 flex flex-col gap-4 md:flex-row">
                    ...
                    <button type="submit"
                            class="flex-1 rounded-2xl bg-[#4b3f8f] px-6 py-4 font-extrabold text-white shadow-lg transition hover:bg-[#3c3277]">
                        Create Course
                    </button>
                </div>
