    ...
    <div class="mb-6 overflow-hidden rounded-[32px] bg-gradient-to-r from-amber-500 via-orange-500 to-red-500 p-8 text-white shadow-2xl">
        <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <h1 class="mt-2 text-4xl font-extrabold">Edit Course</h1>
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        <div>
                            ...
                            <input type="text" wire:model.live="course_code" placeholder="SE101"
                                   class="w-full rounded-2xl border @error('course_code') border-red-500 bg-red-50 @else border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 @enderror px-5 py-4 text-slate-900 dark:text-white outline-none transition focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model.live="course_name" placeholder="Software Engineering"
                                   class="w-full rounded-2xl border @error('course_name') border-red-500 bg-red-50 @else border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 @enderror px-5 py-4 text-slate-900 dark:text-white outline-none transition focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model.live="instructor" placeholder="Dr. Perera"
                                   class="w-full rounded-2xl border @error('instructor') border-red-500 bg-red-50 @else border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 @enderror px-5 py-4 text-slate-900 dark:text-white outline-none transition focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10">
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        <div>
                            ...
                            <input type="number" wire:model.live="credits" placeholder="3"
                                   class="w-full rounded-2xl border @error('credits') border-red-500 bg-red-50 @else border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 @enderror px-5 py-4 text-slate-900 dark:text-white outline-none transition focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10">
                        ...
                        <div>
                            ...
                            <input type="number" wire:model.live="capacity" placeholder="50"
                                   class="w-full rounded-2xl border @error('capacity') border-red-500 bg-red-50 @else border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 @enderror px-5 py-4 text-slate-900 dark:text-white outline-none transition focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10">
                        ...
                        <div>
                            ...
                            <input type="number" wire:model.live="enrolled" placeholder="0"
                                   class="w-full rounded-2xl border @error('enrolled') border-red-500 bg-red-50 @else border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 @enderror px-5 py-4 text-slate-900 dark:text-white outline-none transition focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10">
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        <div>
                            ...
                            <input type="text" wire:model.live="schedule" placeholder="Mon/Wed 9:00 AM - 10:30 AM"
                                   class="w-full rounded-2xl border @error('schedule') border-red-500 bg-red-50 @else border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 @enderror px-5 py-4 text-slate-900 dark:text-white outline-none transition focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model.live="room" placeholder="Room A-101"
                                   class="w-full rounded-2xl border @error('room') border-red-500 bg-red-50 @else border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 @enderror px-5 py-4 text-slate-900 dark:text-white outline-none transition focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10">
