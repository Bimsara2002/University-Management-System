<div class="min-h-screen">
    <div class="mb-6 overflow-hidden rounded-[32px] bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 p-8 text-white shadow-2xl">
        <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <h1 class="mt-2 text-4xl font-extrabold">Add New Instructor</h1>
    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-4">
        ...
        <div class="rounded-[30px] border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-xl lg:col-span-1 transition-colors">
            <div class="mx-auto flex h-24 w-24 items-center justify-center rounded-full bg-indigo-100 dark:bg-indigo-900/50 text-4xl font-extrabold text-indigo-600 dark:text-indigo-400">
            ...
            <form wire:submit.prevent="save" class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select wire:model.live="designation"
                                    class="w-full rounded-2xl border @error('designation') border-red-500 bg-red-50 @else border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 @enderror px-5 py-4 text-slate-900 dark:text-white outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10">
                ...
                <div class="flex flex-col gap-3 border-t border-slate-100 dark:border-slate-800 pt-6 md:flex-row md:justify-end">
                    ...
                    <button type="submit"
                        ...
                        <span wire:loading.remove>Save Instructor</span>
