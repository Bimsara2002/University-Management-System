    ...
    <div class="mb-6 overflow-hidden rounded-[32px] bg-gradient-to-r from-amber-500 via-orange-500 to-red-500 p-8 text-white shadow-2xl">
        <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <h1 class="mt-2 text-4xl font-extrabold">Edit Result</h1>
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select wire:model.live="course_id"
                                    class="w-full rounded-2xl border @error('course_id') border-red-500 bg-red-50 @else border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 @enderror px-5 py-4 text-slate-900 dark:text-white outline-none transition focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" wire:model.live="semester" placeholder="e.g. 2024/25 Sem 1"
                                   class="w-full rounded-2xl border @error('semester') border-red-500 bg-red-50 @else border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 @enderror px-5 py-4 text-slate-900 dark:text-white outline-none transition focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" wire:model.live="marks_obtained" placeholder="0.00"
                                   class="w-full rounded-2xl border @error('marks_obtained') border-red-500 bg-red-50 @else border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 @enderror px-5 py-4 text-slate-900 dark:text-white outline-none transition focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" wire:model.live="total_marks" placeholder="100"
                                   class="w-full rounded-2xl border @error('total_marks') border-red-500 bg-red-50 @else border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 @enderror px-5 py-4 text-slate-900 dark:text-white outline-none transition focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea wire:model.live="remarks" rows="2" placeholder="e.g. Pass, Fail, Excellence Award..."
                                      class="w-full rounded-2xl border @error('remarks') border-red-500 bg-red-50 @else border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 @enderror px-5 py-4 text-slate-900 dark:text-white outline-none transition focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10"></textarea>
